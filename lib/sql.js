 ...
 * @private
 */
SQLConnector.prototype.replaceAttributes = function(model, id, data, options, cb) {
  if (!isIdValuePresent(id, cb)) {
    return;
  }
  var idName = this.idName(model);
  ...
  var where = {};
  where[idName] = id;
  this.replaceAll(model, where, data, options, cb);
};
 ...
 * @param {Function} cb The callback function
 */
SQLConnector.prototype.replace = function(model, where, data, options, cb) {
  var self = this;
